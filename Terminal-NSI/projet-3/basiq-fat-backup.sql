...
CREATE TABLE "cours_collectifs_possible"(
    "identifiant_du_cours_possible" INTEGER,
  	PRIMARY KEY("identifiant_du_cours_possible")
);
...
ALTER TABLE "cours_collectifs_possible" ADD COLUMN "identifiant_du_cours" TEXT REFERENCES "cours_collectif"("identifiant_du_cours");
